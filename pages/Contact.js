        ...
        <Grid container justify="center" alignItems="center" spacing={3} style={{ margin: '100px 0' }}>
          ...
          <Grid item xs={3}>
            <ContactCard>
              ...
              <Typography align="center">(+84) 0586 434 251</Typography>
            </ContactCard>
          </Grid>
          <Grid item xs={3}>
            <ContactCard>
          ...
          <Grid item xs={3}>
            <ContactCard>
              ...
              <Typography align="center" noWrap>
                tranhoang.finizz@gmail.com
              </Typography>
              <Typography align="center" noWrap>
                hnbtranspkt@gmail.com
              </Typography>
            </ContactCard>
          </Grid>
        </Grid>
        ...
        <Grid container>
          <Grid item xs={12} style={{ background: 'rgb(21, 33, 54)', padding: '120px 0', color: 'white' }}>
            ...
            <Grid container alignItems="center" justify="center">
              <Link href="https://www.facebook.com/kudokun0711/" target="_blank">
                <StyledFab>
                  <FaFacebook style={{ fontSize: 30, color: '#eee' }} />
                </StyledFab>
              </Link>
              <Link href="https://github.com/nightmare711" target="_blank">
                <StyledFab>
          ...
          <Grid item xs={12} alignContent="center" style={{ background: 'rgb(28, 41, 64)' }}>
            <Typography align="center" style={{ color: 'white', margin: '16px 0' }}>Copyright © 2019. All rights reserved by Nightmare!</Typography>
          </Grid>
        </Grid>
      </div>
    );
